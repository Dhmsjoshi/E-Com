...
//    }
    ...
    @Operation(summary = "Reduce product stock", description = "Partial update to decrease stock")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Stock patched successfully"),
